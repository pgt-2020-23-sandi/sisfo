...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i>poltek gt</a></h1>

			</div>
			<div class="w3layouts_header_right">
			    <form action="#" method="post">
					<input name="Search here" type="search" placeholder="Cari" required="">
					<input type="submit" value="">
				</form>
			</div>
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Masuk sekarang</a> </li>
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				...
				<h4>Silahkan isi data berikut (optional)</h4>
				<form action="#" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="text">Prodi Kesukaan  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="name" type="text" required=""></li>
							<li class="text">Jenis Kelamin  :  </li>
...
<div class="about-top" id="about">
	<div class="container">
		...
		<div class="col-md-5 wthree-about-grids">
			<h4>Selamat datang di Politeknik Gajah Tunggal</h4>
			<a href="https://poltek-gt.ac.id/v2/" class="trend-w3l" data-toggle="https://poltek-gt.ac.id/v2/" data-target="https://poltek-gt.ac.id/v2/"><span>Lebih lanjut</span></a>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">Jumlah Pengunjung</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">Prestasi Kampus</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">Prestasi Mahasiswa</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">Dosen Terampil</h4>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>Ada perpustakaan, Cafetaria, Ruang Kelas, Lab.komputer, Lab.mekanik, Lab.instrumentasi, Taman, Tempat Olahraga.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Dosen yang Bermutu</h5>
				<p>Pemberian materi yang mudah dipahami dan membuat mahasiswa menjadi lulusan yang terampil dan mempunyai skill tinggi.</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>03</h6>
				<h5>Beasiswa</h5>
				<p>Kuliah Gratis, Lulus langsung kerja, Mendapatkan uang saku satu bulan.</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
		...
		<div class="team-w3l-grid">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/t2.jpg" alt="">
				  <h5>Ridwan A.C</h5>
				  <div class="about_opa">
					<p>Kaprodi Teknik Elektornika</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 Scholarly. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka. Modified by Sandi, Pak Ade, Hasan</p>
	</div>
</div>
	<?php } else{ ?>
